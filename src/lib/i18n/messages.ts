...
const en = {
  ...
  account: {
    ...
    readyTitle: "Ready for the next login",
    readyDescription: "Launcher, ladder and character profile are one click away.",
...
const es: DeepPartial<Messages> = {
  ...
  account: {
    ...
    playerHubTitle: "Foco del personaje",
    playerHubDescription: "Tu ruta principal de vuelta al servidor empieza aquí.",
    featuredCharacterTitle: "Foco del personaje",
    ...
    readyTitle: "Listo para el próximo login",
    readyDescription: "Launcher, ladder y perfil de personaje a un clic.",

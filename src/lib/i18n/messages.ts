...
const en = {
  ...
  common: {
    ...
    delivery: "Delivery",
    technicalDetails: "Advanced details",
    rawEventDetails: "Event details",
  ...
  home: {
    ...
    identityEyebrow: "Server flavor",
    identityTitle: "Built for guild wars, boss runs and class mains.",
    identityDescription: "Clean layout. Real Metin2 signals.",
    identityClassesTitle: "Classes on the board",
    identityClassesDescription: "Pick your main and start climbing.",
    identityGuildWarsTitle: "Guild wars",
    identityGuildWarsDescription: "Track the clans already pushing the ladder.",
    identityGuildWarsEmpty: "No guilds are showing on the board yet.",
    identityBossRunsTitle: "Boss runs",
    identityBossRunsDescription: "Patch in, level fast and chase the next drop.",
    identityBossRunsEmpty: "No players are visible on the board yet.",
  ...
  downloads: {
    ...
    releaseSnapshotTitle: "Release snapshot",
    releaseArchiveLabel: "Archive",
    releaseBuildTagLabel: "Build tag",
    releaseUpdatedLabel: "Updated",
    releaseSizeLabel: "Size",
    contentsTitle: "What is inside",
    contentsLauncher: "Auto-updating launcher",
    contentsBaseClient: "Base client included",
    contentsResume: "Resume-friendly archive",
    releaseNotesTitle: "Current release notes",
  ...
  account: {
    eyebrow: "Account",
    heroDescription: "Characters, launcher path and account access in one place.",
    emailLabel: "Email",
    activeSessions: (count: number) => `${count} active session${count === 1 ? "" : "s"}`,
    charactersReady: (count: number) => `${count} character${count === 1 ? "" : "s"} ready`,
    downloadsAction: "Downloads",
    rankingsAction: "Rankings",
    signOutAction: "Sign out",
    playerHubBadge: "Player hub",
    playerHubTitle: "Character info",
    playerHubDescription: "Your main character and recent session signals, in one place.",
    featuredCharacterTitle: "Character info",
    featuredCharacterDescription: "Highest-level character tied to this account.",
    openCharacterProfile: "Open character profile",
    readyTitle: "Session info",
    readyDescription: "Characters, last play and the previous sign-in IP.",
    previousLoginIpTitle: "Last IP",
...
const es: DeepPartial<Messages> = {
  ...
  common: {
    ...
    userAgent: "User agent",
    delivery: "Entrega",
    technicalDetails: "Detalles avanzados",
  ...
  home: {
    ...
    identityEyebrow: "Sabor del servidor",
    identityTitle: "Clases, guerras de gremios y cacerías de boss.",
    identityDescription: "Diseño limpio. Señales reales de Metin2.",
    identityClassesTitle: "Clases en el ladder",
    identityClassesDescription: "Elige main y empieza a escalar.",
    identityGuildWarsTitle: "Guerras de gremios",
    identityGuildWarsDescription: "Sigue a los clanes que ya están empujando el ladder.",
    identityGuildWarsEmpty: "Todavía no hay gremios visibles en la tabla.",
    identityBossRunsTitle: "Cacerías de boss",
    identityBossRunsDescription: "Parchea, sube rápido y ve a por el siguiente drop.",
    identityBossRunsEmpty: "Todavía no hay jugadores visibles en la tabla.",
  ...
  downloads: {
    ...
    releaseSnapshotTitle: "Snapshot de la release",
    releaseArchiveLabel: "Archivo",
    releaseBuildTagLabel: "Build tag",
    releaseUpdatedLabel: "Actualizado",
    releaseSizeLabel: "Tamaño",
    contentsTitle: "Qué incluye",
    contentsLauncher: "Launcher con auto-actualización",
    contentsBaseClient: "Cliente base incluido",
    contentsResume: "Archivo reanudable",
    releaseNotesTitle: "Notas de la release actual",
  ...
  account: {
    heroDescription: "Personajes, launcher y acceso de cuenta en un solo sitio.",
    emailLabel: "Email",
    activeSessions: (count) => `${count} sesión${count === 1 ? "" : "es"} activa${count === 1 ? "" : "s"}`,
    charactersReady: (count) => `${count} personaje${count === 1 ? "" : "s"} listo${count === 1 ? "" : "s"}`,
    downloadsAction: "Descargas",
    rankingsAction: "Rankings",
    signOutAction: "Salir",
    playerHubBadge: "Hub de jugador",
    playerHubTitle: "Información del personaje",
    playerHubDescription: "Tu personaje principal y las señales clave de sesión, en un solo bloque.",
    featuredCharacterTitle: "Información del personaje",
    featuredCharacterDescription: "Personaje de mayor nivel vinculado a esta cuenta.",
    openCharacterProfile: "Abrir perfil del personaje",
    readyTitle: "Información de sesión",
    readyDescription: "Personajes, último juego y la IP del inicio de sesión anterior.",
    previousLoginIpTitle: "Última IP",
